...
urlpatterns = [
    ...
    path("meetings/live/", views.meeting_live, name="meeting_live"),
    path("meetings/<int:meeting_id>/", views.meeting_detail, name="meeting_detail"),
    path("meetings/<int:meeting_id>/audio/", views.meeting_audio, name="meeting_audio"),
    ...
    path("meetings/<int:meeting_id>/diarize/", views.meeting_diarize, name="meeting_diarize"),
    path(
        "meetings/<int:meeting_id>/reprocess/",
        views.meeting_reprocess,
        name="meeting_reprocess",
    ),
    path(
        "meetings/<int:meeting_id>/summarize-stream/",
        views.meeting_summarize_stream,
        name="meeting_summarize_stream",
    ),
    path("meetings/<int:meeting_id>/enroll/", views.meeting_enroll, name="meeting_enroll"),
    path(
        "meetings/<int:meeting_id>/rename-speaker/",
        views.meeting_rename_speaker,
        name="meeting_rename_speaker",
    ),
    path(
        "meetings/<int:meeting_id>/send-to-phase/",
        views.meeting_send_to_phase,
        name="meeting_send_to_phase",
    ),
    path(
        "meetings/utterances/<int:utterance_id>/edit/",
        views.utterance_edit,
        name="utterance_edit",
    ),
    ...
    path("speakers/<int:speaker_id>/enroll/", views.speaker_enroll, name="speaker_enroll"),
    path("meetings/series/", views.series_list, name="series_list"),
    path("meetings/series/new/", views.series_create, name="series_create"),
    path("meetings/series/<int:series_id>/", views.series_detail, name="series_detail"),
    path("meetings/series/<int:series_id>/edit/", views.series_edit, name="series_edit"),
    path(
        "meetings/series/<int:series_id>/delete/",
        views.series_delete,
        name="series_delete",
    ),
    path(
        "meetings/series/<int:series_id>/summarize-stream/",
        views.series_summarize_stream,
        name="series_summarize_stream",
    ),
]
